...
- ts_iso: 2026-03-11T22:45:48.665552+00:00
- mode: explore
- lane: BTC / 1h
...
- QD-20260312-C064-ETH-1H-VALUE-RECOVERY-SCALEIN-v1: asset=ETH | timeframe=1h | decision=red_flag | diagnosis=too sparse
...
- QD-20260312-C064-BTC-1H-ASYMMETRIC-CONTINUATION-v1: asset=BTC | timeframe=1h | decision=red_flag | diagnosis=too sparse
  ...
  why: I got 0 trades on valid data (integrity_skip:zero_trades_both_samples; integrity_skip:zero_trades_both_samples) — I must explicitly choose refine or abort.
- QD-20260312-C064-AXS-1H-RETEST-HOLD-TIMEOUT-v1: asset=AXS | timeframe=1h | decision=red_flag | diagnosis=too sparse
